...
docker run -itd --name hm-oracle -p 1521:1521 -p 5500:5500 -e ORACLE_SID=hm -e ORACLE_PDB=nhm -v /home/jb/Workspace/JVM/Java/hibernate-mappings/src/main/resources/oracle/19.3.0/custom_scripts:/opt/oracle/scripts/setup oracle/database:19.3.0-ee
